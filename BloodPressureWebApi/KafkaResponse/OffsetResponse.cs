...
namespace BloodPressureWebApi.KafkaResponse
{
    public class OffsetResponse
    {
        ...
        private readonly Dictionary<string, List<OffsetPartitionResponse>> offsetPartitions = new Dictionary<string, List<OffsetPartitionResponse>>();
        ...
        public OffsetResponse(byte[] data)
        {
            ...
            for (int topicIndex = 0; topicIndex < numTopics; topicIndex++)
            {
                ...
                var offsetPartitionList = new List<OffsetPartitionResponse>(partitionCount);
                ...
                for (var i = 0; i < partitionCount; i++)
                {
                    ...
                    var partition = new OffsetPartitionResponse(errorCode, partitionId);
