...
using BloodPressureWebApi.KafkaException;
...
namespace BloodPressureWebApi.KafkaClient
{
    public class KafkaBusConnector
    {
        ...
        public KafkaMessageStream CreateMessageStream1(string topicName, int partitionId, long offset)
        {
        ...
        public void Produce(string topicName, int partitionId, string data)
        {
            try
            {
            ...
            {
                throw new KafkaException.KafkaException(ex.Message);
            }
        }
        ...
        private KafkaTopic TopicFromResponse(OffsetResponse offsetResponse)
        {
            ...
            if (errorCode != 0)
            {
                ...
                throw new KafkaException.KafkaException(errorCode);
            }
